...
<div class="x-body">
    ...
    <!--
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','/admin/franchise_course/add', 500)">
...
<script>
    layui.use('laypage', function(){
        ...
        var url = '/admin/franchise_course/list?'+"{{$data['_query']}}";
    ...
    layui.use('form', function(){
        ...
        form.on('submit(sreach)', function(data){
            if (data.field.title == '') {
                location.href = '/admin/franchise_course/list';
            }

            location.href = '/admin/franchise_course/list?title=' + data.field.title;
        });
    });
    ...
    function add_franchise_course() {
        location.href = "/admin/franchise_course/add";
    }

    /*编辑*/
    function edit_franchise_course(id) {
        location.href = "/admin/franchise_course/edit/"+id;
    }
</script>
</body>
</html>